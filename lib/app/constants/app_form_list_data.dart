class AppFormListData {
  static Map<String, Map<String, List<String>>> countryMap = {
    "India": indiaMap,
    "Afghanistan": afghanistanMap,
    "Albania": albaniaMap,
    "Algeria": algeriaMap,
    "American Samoa": americanSamoaMap,
    'Australia': {
  ...
  static Map<String, List<String>> indiaMap = {
  ...
  static Map<String, List<String>> afghanistanMap = {
  ...
  static Map<String, List<String>> albaniaMap = {
  ...
  static Map<String, List<String>> algeriaMap = {
    "Algiers": [
      "Algiers",
      "Bab El Oued",
      "Kouba",
  ...
  static Map<String, List<String>> americanSamoaMap = {
